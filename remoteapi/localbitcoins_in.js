...
const urls = {
    btc : [
        'https://localbitcoins.com/sell-bitcoins-online/INR/national-bank-transfer/.json',
        'https://localbitcoins.com/buy-bitcoins-online/INR/national-bank-transfer/.json'
    ]
};
